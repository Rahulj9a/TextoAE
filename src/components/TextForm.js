...
export default function TextForm(props) {
  ...
  let wordsInText = text.split(/\s+/).filter(e=>e.length!==0)
  
  let totalCharacters =  wordsInText.reduce((total,e)=>total+e.length,0)
  ...
  return (
       <>
            ...
            <div className="container my-3">
                 ...
                 >
                      Total words = {wordsInText.length}
                 </p>
                 <hr />
                 <p
                      style={{
                 ...
                 >
                      Approx time to read = {(wordsInText * 0.005).toFixed(2)}{" "}
                      minutes
                 </p>
                 <hr />
                 <p
